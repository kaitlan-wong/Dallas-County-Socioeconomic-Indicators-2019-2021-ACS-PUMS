---
title: "DEI ACS PUMS Data Checks - Indicator 12: Working Poverty - 2016-2017 (2019 method)"
author: "Kaitlan Wong"
format: html
editor: visual
---
...
# Get ACS data
pums17 <- get_pums(
  variables = c("AGEP", "RAC1P", "HISP", "PUMA", "POVPIP", "WKW", "WKHP"),
  state = "TX",
  survey = "acs1",
  year = 2017,
  recode = TRUE,
...
data17 <- pums17 %>%
  filter(PUMA %in% c("02304", "02305", "02306", "02307", "02309", "02310", "02311", "02312", "02313", "02314", "02315", "02316", "02319", "01901", "02001"),
         ...
         WKW == 1, # this is the 2019 method, rather than using ESR. We are filtering for adults that worked 50-52 weeks in the apst year.
...
# Get ACS data
pums16 <- get_pums(
  variables = c("AGEP", "RAC1P", "HISP", "PUMA", "WKHP", "POVPIP", "WKW"),
  state = "TX",
  survey = "acs1",
  year = 2016,
  recode = TRUE,
...
write_xlsx(list("2017" = summary17, "2016" = summary16), "12_Working Poverty_16_17_2019 method.xlsx")
```
