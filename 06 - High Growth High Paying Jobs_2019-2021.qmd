---
title: "DEI ACS PUMS Data Checks - Indicator 6: High-Growth, High-Paying Employment"
author: "Kaitlan Wong"
format: html
editor: visual
---
...
data21 <- pums21 %>%
  ...
  mutate(race_eth = case_when(
   ...
   mutate(hghp = case_when(
     str_detect(SOCP, "^(11|23|15|17|29|13|19)") ~ "HGHP",
     TRUE ~ "Not HGHP")
   )
...
write_xlsx(list("2021" = summary21, "2019" = summary19), "06_HGHP Jobs_19_21.xlsx")
```
