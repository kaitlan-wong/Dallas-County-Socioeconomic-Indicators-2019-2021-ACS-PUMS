---
title: "DEI ACS PUMS Data Checks - Indicator 12: Working Poverty - 2016-2017"
author: "Kaitlan Wong"
format: html
editor: visual
---
...
# Get ACS data
pums17 <- get_pums(
  variables = c("AGEP", "RAC1P", "HISP", "PUMA", "POVPIP", "ESR", "WKHP"),
  state = "TX",
  survey = "acs1",
  year = 2017,
  recode = TRUE,
...
# Get ACS data
pums16 <- get_pums(
  variables = c("AGEP", "RAC1P", "HISP", "PUMA", "WKHP", "POVPIP", "ESR"),
  state = "TX",
  survey = "acs1",
  year = 2016,
  recode = TRUE,
...
# 2016 calculations seem to be incorrect. While my 2017 data matched data I downloadewd from the MDAT online tool, this 2016 rate for Hispanic residents does not match the MDAT.
```

```{r}
# Export tables to Excel

write_xlsx(list("2017" = summary17, "2016" = summary16), "12_Working Poverty_16_17.xlsx")
```
