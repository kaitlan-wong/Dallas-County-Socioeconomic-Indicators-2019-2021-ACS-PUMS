...
data17 <- pums17 %>%
  filter(PUMA %in% c("02304", "02305", "02306", "02307", "02309", "02310", "02311", "02312", "02313", "02314", "02315", "02316", "02319", "01901", "02001")) %>%
         ...
         # HINCP >= 0) %>% <- trying to replicate 2019 analysis, so removing HH income filter
...
write_xlsx(list("2017" = summary17, "2016" = summary16), "09_Median Household Income_16_17_no filter.xlsx")
```
