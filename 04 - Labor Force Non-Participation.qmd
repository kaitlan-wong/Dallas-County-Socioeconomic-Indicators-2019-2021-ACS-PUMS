---
title: "DEI ACS PUMS Data Checks - Indicator 4: Labor Force Non-Participation"
author: "Kaitlan Wong"
format: html
editor: visual
---
...
summary21 <- data21 %>%
  group_by(race_eth) %>%
  summarize(
    count = sum(PWGTP[non_lf == "Not in LF"]),
    prop = sum(PWGTP[non_lf == "Not in LF"]) / sum(PWGTP)
  )
...
write_xlsx(list("2021" = summary21, "2019" = summary19), "04_Labor Force Non-Participation.xlsx")
```
